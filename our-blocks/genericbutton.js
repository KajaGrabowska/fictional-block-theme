...
function EditComponent(props) {
    ...
    function handleTextChange(currentUserInput) {
        props.setAttributes({text: currentUserInput})
    }

    function buttonHandler() {
        setIsLinkPickerVisible(prev => !prev);      // start with the previous value, set to
                                                    // the opposite of the prev value
    }
